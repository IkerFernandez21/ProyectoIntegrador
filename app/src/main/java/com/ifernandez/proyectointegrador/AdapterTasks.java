...
public class AdapterTasks extends RecyclerView.Adapter<AdapterTasks.ViewHolder> {
    ...
    //ViewHolder ya existente. En nuestro ejemplo recuperaremos el objeto
    //Animal correspondiente a la posición recibida como parámetro y
    //asignaremos sus datos sobre el ViewHolder también recibido como
    //parámetro
    ...
    //Contiene las vistas o controles de cada elemento de la lista-> checkBox a cada elemento de la lista
